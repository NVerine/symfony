...
final class Version20200526193546 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE quiz_questions (id INT AUTO_INCREMENT NOT NULL, quiz_id INT NOT NULL, question_id INT NOT NULL, ordem INT NOT NULL, weight INT NULL, INDEX IDX_8CBC2533853CD175 (quiz_id), INDEX IDX_8CBC25331E27F6BF (question_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_tokens (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, origin VARCHAR(255) NOT NULL, is_active TINYINT(1) NOT NULL, user_agent VARCHAR(255) NOT NULL, data DATETIME NOT NULL, token VARCHAR(255) NOT NULL, INDEX IDX_CF080AB3A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
